...
public class SolutionOptimise {
    ...
    public Map<String, String> genererSolutionAdaptative() {
        ...
        if (nombreColons <= 10) {
            ...
            return optimiseSolution2(1000); // Nombre d'itérations arbitraire
        }
    }
    ...
    public Map<String, String> rechercheExhaustive() {
        ...
        for (List<String> permutation : permutations) {
            ...
            if (jalousie < minJalousie) {
                ...
                if (minJalousie == 0) {
                    System.out.println("Solution optimale trouvée avec coût = 0 : " + meilleureAffectation);
                    break;
                }
            }
        }
        ...
        System.out.println("Recherche exhaustive terminée avec une jalousie minimale de " + minJalousie);
        System.out.println("Solution finale : " + meilleureAffectation);
